    ...
    return {
        init: function () {
            ...
            a.addEventListener("click", (function (o) {
                ...
                o.preventDefault(), toastr.success("Process has been started and it may take a while.", "Generating HTML!", {
                    timeOut: 0,
                    extendedTimeOut: 0,
                    closeButton: !0,
                    closeDuration: 0
                }), i.setAttribute("data-kt-indicator", "on"), t.value = "export";
                var a = $(e).serialize();
                $.ajax({
                    type: "POST",
                    dataType: "html",
                    ...
                    success: function (e, t, o) {
                        var a = setInterval((function () {
                            $("<iframe/>").attr({
                                src: r + "?layout-builder[action]=export&download=1&output=" + e,
            ...
            })), c = document.querySelector("#kt_layout_builder_theme_mode_light"), u = document.querySelector("#kt_layout_builder_theme_mode_dark"), s = document.querySelector("#kt_layout_builder_theme_mode_" + KTThemeMode.getMode()), c && c.addEventListener("click", (function () {
