...
var KTAppEcommerceReportShipping = function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_ecommerce_report_shipping_table")) && (t.querySelectorAll("tbody tr").forEach((t => {
                ...
                }).container().appendTo($("#kt_ecommerce_report_shipping_export")), document.querySelectorAll("#kt_ecommerce_report_shipping_export_menu [data-kt-ecommerce-export]").forEach((t => {
