            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    o = {
                        ...
                        xaxis: {
                            categories: ['15 Apr', '16 Apr', '17 Apr', '18 Apr', '19 Apr', '20 Apr', '21 Apr'],
                            axisBorder: {
                                show: false
                            },
                            axisTicks: {
                        ...
                        // colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")],
                        colors: ["#8674cc", "#038edc", "#ffa196", "#ffce9a", "#2c322d"],
                        grid: {
                            borderColor: r,
                            strokeDashArray: 0,
                            yaxis: {
...
var KTChartsWidget22 = function () {
    var e = function (e, t, a, l) {
        ...
        if (r) {
            ...
            var o = {
                ...
                colors: ["#038edc", "#ffa196", "#ffce9a", "#2c322d"],
                stroke: {
                    width: 0
                },
                labels: ["Submitted", "Failed", "DND", "Blacklist"],
                dataLabels: {
                    enabled: false,
    ...
    return {
        init: function () {
            e("#kt_chart_widgets_22_tab_1", "#kt_chart_widgets_22_chart_1", [1680, 1500, 500, 200], !0), e("#kt_chart_widgets_22_tab_2", "#kt_chart_widgets_22_chart_2", [70, 13, 11, 2], !1)
        }
    }
}();
